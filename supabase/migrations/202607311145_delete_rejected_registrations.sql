-- Rejected independent registrations are deleted completely from Auth.
-- The profiles row and related verification state are removed through ON DELETE CASCADE.
